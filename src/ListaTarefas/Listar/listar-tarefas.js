...
import ItensListaTarefas from "../ItemsLista/itens-lista-tarefas";
...
function ListarTarefas() {
  ...
  const [ordernarAsc, setOrdenarAsc] = useState(false);
  ...
  }, [carregarTarefas, filtroTarefa, ordenarDesc, ordernarAsc, paginaAtual]);
          ...
          <tr>
            <th>
              <a href="/" onClick={handleOrdenar}>
                Tarefa &nbsp;
                <Ordenacao ordenarAsc={ordernarAsc} ordenarDesc={ordenarDesc} />
              </a>
            </th>
